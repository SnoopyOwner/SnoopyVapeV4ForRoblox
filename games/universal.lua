...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('snoopyvape/assets/new/blur.png')
...
local hash = loadstring(downloadFile('snoopyvape/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('snoopyvape/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('snoopyvape/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('snoopyvape/profiles/whitelist.json') and readfile('snoopyvape/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('snoopyvape/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		EntityArrow.Image = getcustomasset('snoopyvape/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('snoopyvape/assets/new/radaricon.png'),
	...
	ChinaHat = vape.Legit:CreateModule({
		...
		Function = function(callback)
			if callback then
				...
				hat.Size = Vector3.new(1.1, 1.1, 1.1)
